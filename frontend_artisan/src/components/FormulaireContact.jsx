    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:3000/contacts', {
                ...
                body: JSON.stringify({
                    nom_expediteur: formData.nom,
                    prenom_expediteur: formData.prenom,
            ...
            <form onSubmit={handleSubmit}>
                <div className="row g-3">
                    <div className="col-12 col-lg-12 pb-4">
                        ...
                        <input id="nom" name="nom" type="text" className="form-control rounded-4 p-3" placeholder="Votre nom" value={formData.nom_expediteur} onChange={handleChange} required />
                        <label className="form-label">Prénom</label>
                        <input id="prenom" name="prenom" type="text" className="form-control rounded-4 p-3" placeholder="Votre prénom" value={formData.prenom_expediteur} onChange={handleChange} required />
                        <label className="form-label">Email</label>
                        <input id="email" name="email" type="email" className="form-control rounded-4 p-3" placeholder="Votre email" value={formData.email_expediteur} onChange={handleChange} required />
